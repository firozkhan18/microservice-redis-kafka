 ...
 */
package com.springboot.microservice.adapters.aop;
...
import com.springboot.microservice.domain.exceptions.AbstractServiceException;
import com.springboot.microservice.domain.exceptions.AuthorizationException;
import com.springboot.microservice.domain.exceptions.BusinessServiceException;
import com.springboot.microservice.domain.exceptions.ControllerException;
import com.springboot.microservice.domain.exceptions.DataNotFoundException;
import com.springboot.microservice.domain.exceptions.DatabaseException;
import com.springboot.microservice.domain.exceptions.DuplicateDataException;
import com.springboot.microservice.domain.exceptions.InputDataException;
import com.springboot.microservice.domain.exceptions.JWTTokenExpiredException;
import com.springboot.microservice.domain.exceptions.JWTTokenExtractionException;
import com.springboot.microservice.domain.exceptions.JWTTokenSubjectException;
import com.springboot.microservice.domain.exceptions.JWTUnDefinedException;
import com.springboot.microservice.domain.exceptions.MandatoryDataRequiredException;
import com.springboot.microservice.domain.exceptions.MessagingException;
import com.springboot.microservice.domain.exceptions.ResourceException;
import com.springboot.microservice.domain.exceptions.ResourceNotFoundException;
import com.springboot.microservice.domain.exceptions.SecurityException;
import com.springboot.microservice.domain.exceptions.UnableToSaveException;
import com.springboot.microservice.domain.models.core.StandardResponse;
