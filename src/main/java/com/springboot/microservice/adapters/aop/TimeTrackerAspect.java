...
public class TimeTrackerAspect {
     ...
     * @param joinPoint
     */
    @Before(value = "execution(* com.springboot.microservice.adapters.controllers.*.*(..))")
     ...
     * @param joinPoint
     */
    @After(value = "execution(* com.springboot.microservice.adapters.controllers.*.*(..))")
     ...
     * @throws Throwable
     */
    @Around(value = "execution(* com.springboot.microservice.adapters.controllers.*.*(..))")
     ...
     * @throws Throwable
     */
    @Around(value = "execution(* com.springboot.microservice.adapters.service.*.*(..))")
     ...
     * @throws Throwable
     */
    @Around(value = "execution(* com.springboot.microservice.adapters.repository.*.*(..))")
     ...
     * @throws Throwable
     */
    @Around(value = "execution(* com.springboot.microservice.adapters.external.*.*(..))")
