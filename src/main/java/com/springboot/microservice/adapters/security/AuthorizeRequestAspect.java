...
import com.springboot.microservice.security.JsonWebToken;
...
public class AuthorizeRequestAspect {
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.springboot.microservice.adapters.security.ValidateRefreshToken)")
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.springboot.microservice.adapters.security.SingleTokenAuthorizationRequired)")
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.springboot.microservice.adapters.security.AuthorizationRequired)")
     ...
     * @throws Throwable
     */
    @Around(value = "execution(* com.springboot.microservice.adapters.controllers.secured.*.*(..))")
     ...
     * @throws Throwable
     */
    @Around(value = "execution(* com.springboot.microservice.adapters.controllers.internal.*.*(..))")
     ...
     * @throws Throwable
     */
    @Around(value = "execution(* com.springboot.microservice.adapters.controllers.external.*.*(..))")
