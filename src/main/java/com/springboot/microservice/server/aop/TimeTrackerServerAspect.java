 ...
 */
package com.springboot.microservice.server.aop;
...
public class TimeTrackerServerAspect {
     ...
     * @param joinPoint
     */
    @Before(value = "execution(* com.springboot.microservice.server.controllers.*.*(..))")
     ...
     * @param joinPoint
     */
    @After(value = "execution(* com.springboot.microservice.server.controllers.*.*(..))")
     ...
     * @throws Throwable
     */
    @Around(value = "execution(* com.springboot.microservice.server.controllers.*.*(..))")
