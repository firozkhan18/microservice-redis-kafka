 ...
 */
@Configuration
@EntityScan("com.springboot.microservice.domain.*")
@EnableJpaRepositories(basePackages = { "com.springboot.microservice.adapters.repository" })//"com.springboot.microservice.domain.ports",
...
public class DatabaseSetup {
    ...
    public jakarta.persistence.EntityManagerFactory entityManagerFactory() {
        ...
        //String[] pkgs = {"com.springboot.microservice.domain.*"};
        factory.setPackagesToScan("com.springboot.microservice.domain"); // Use correct package
