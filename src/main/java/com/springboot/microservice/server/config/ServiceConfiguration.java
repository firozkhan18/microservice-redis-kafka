 ...
 */
package com.springboot.microservice.server.config;
...
@Component
@Configuration
@PropertySource(name = "serviceConfig",
...
public class ServiceConfiguration implements Serializable {
	...
	/**
	 * To be used outside SpringBoot Context For WireMock Testing the External
	 * Services
	 */
	...
	/**
	 * Returns Token Type Token Type is used to sign the JWTs. 1 = secret key, 2 =
	 * public / private key
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the Ack Type for Topic 1 Ack Types = All, 1, 0 All = Acknowledgement
	 * By All the Replicas 1 = Acknowledgement By the Leader 0 = Acknowledgement By
	 * None
	 *
	 * @return
	 */
